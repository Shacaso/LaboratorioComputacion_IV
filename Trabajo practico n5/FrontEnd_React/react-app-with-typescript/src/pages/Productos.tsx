...
function Productos() {
    ...
    var instrumentos:any[] =  [];
    getJSON().then(element => {
        element.map(e=>instrumentos.push(e))
    }).catch(err => console.log(`>>> ${err}`))


    // instrumentos.map(el=> console.log(el))

    const [instruments, setInstrument] = useState<any[]>(instrumentos)
